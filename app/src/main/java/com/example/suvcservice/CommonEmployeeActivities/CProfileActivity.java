...
import com.example.suvcservice.ITEmployeeActivities.ITProfileActivity;
...
public class CProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout btnStartRequests = findViewById(R.id.buttonStartRequest);
        btnStartRequests.setOnClickListener(view -> {
            Intent intent = new Intent(CProfileActivity.this, CRequestsActivity.class);
        ...
        btnLogoff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Users.logoutUser(CProfileActivity.this);
                Users.saveAuthenticationState(CProfileActivity.this, false);
                Intent intent = new Intent(CProfileActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        mRequestAdapter = new RequestsAdapter(CProfileActivity.this, mRequests);
        lvRequests.setAdapter(mRequestAdapter);
        new getRequest(CProfileActivity.this)
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new EditUserProfile(CProfileActivity.this).execute();
                ...
                Users.saveSystemBasket(CProfileActivity.this);
            }
        });
    }
    ...
    class EditUserProfile extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void unused) {
            ...
            if (mProgressDialog.isShowing()) {
                mProgressDialog.dismiss();
                Toast.makeText(CProfileActivity.this, "Данные успешно загружены!", Toast.LENGTH_SHORT).show();
            }
        }
    }
}